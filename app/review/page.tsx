        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <strong className="text-blue-800">Application Reference:</strong>
                <p className="text-lg font-mono text-blue-600">{customer.applicationReferenceNumber}</p>
              </div>
              <div>
                <strong className="text-blue-800">Application Date:</strong>
                <p className="text-lg text-blue-600">{formatDateForDisplay(customer.applicationDate)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 gap-3 text-sm">
                  ...
                  <div><strong>Monthly Income:</strong> {formatCurrency(customer.monthlyIncome || 0)}</div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 gap-3 text-sm">
                  ...
                  <div><strong>Establishment Date:</strong> {customer.dateOfEstablishmentMLB ? formatDateForDisplay(customer.dateOfEstablishmentMLB) : "Not provided"}</div>
                  <div><strong>Other Business:</strong> {customer.otherLineBusiness || "Not provided"}</div>
                  {customer.dateOfEstablishmentOLB && (
                    <div><strong>Establishment Date:</strong> {formatDateForDisplay(customer.dateOfEstablishmentOLB)}</div>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {/* Loan Details */}
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold mb-3 text-gray-800">Loan Details</h3>
                <div className="grid grid-cols-1 gap-3 text-sm">
              ...
              {customer.shareholders && customer.shareholders.length > 0 && (
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold mb-3 text-gray-800">Shareholders</h3>
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-100">
                        <tr>
                          <th className="px-3 py-2 text-left text-xs font-medium text-gray-700">Name</th>
                          <th className="px-3 py-2 text-left text-xs font-medium text-gray-700">Share Value</th>
                          <th className="px-3 py-2 text-left text-xs font-medium text-gray-700">Percentage</th>
                        </tr>
                      </thead>
                      <tbody className="bg-white divide-y divide-gray-200">
                        {customer.shareholders.map((shareholder: any, index: number) => (
                          <tr key={index}>
                            <td className="px-3 py-2 text-sm">{shareholder.name}</td>
                            <td className="px-3 py-2 text-sm">{formatCurrency(shareholder.shareValue)}</td>
                            <td className="px-3 py-2 text-sm">{shareholder.sharePercentage}%</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 gap-2 text-sm">
                  <div className="flex justify-between items-center">
                    ...
                    <span 
                      className={`cursor-pointer ${customer.nationalidUrl ? 'text-green-600 hover:underline' : 'text-red-600'}`}
                      onClick={() => customer.nationalidUrl && openDocument(customer.nationalidUrl)}
                    >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span 
                      className={`cursor-pointer ${customer.agreementFormUrl ? 'text-green-600 hover:underline' : 'text-red-600'}`}
                      onClick={() => customer.agreementFormUrl && openDocument(customer.agreementFormUrl)}
                    >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span 
                      className={`cursor-pointer ${customer.applicationFormUrl ? 'text-green-600 hover:underline' : 'text-red-600'}`}
                      onClick={() => customer.applicationFormUrl && openDocument(customer.applicationFormUrl)}
                    >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span 
                      className={`cursor-pointer ${customer.creditProfileUrl ? 'text-green-600 hover:underline' : 'text-red-600'}`}
                      onClick={() => customer.creditProfileUrl && openDocument(customer.creditProfileUrl)}
                    >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span 
                      className={`cursor-pointer ${customer.transactionProfileUrl ? 'text-green-600 hover:underline' : 'text-red-600'}`}
                      onClick={() => customer.transactionProfileUrl && openDocument(customer.transactionProfileUrl)}
                    >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span 
                      className={`cursor-pointer ${customer.collateralProfileUrl ? 'text-green-600 hover:underline' : 'text-red-600'}`}
                      onClick={() => customer.collateralProfileUrl && openDocument(customer.collateralProfileUrl)}
                    >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span 
                      className={`cursor-pointer ${customer.financialProfileUrl ? 'text-green-600 hover:underline' : 'text-red-600'}`}
                      onClick={() => customer.financialProfileUrl && openDocument(customer.financialProfileUrl)}
                    >
                  ...
                  {customer.majorLineBusinessUrl && (
                    <div className="flex justify-between items-center">
                      ...
                      <span 
                        ...
                        onClick={() => openDocument(customer.majorLineBusinessUrl!)}
                      >
                        ✅ Uploaded
                      </span>
                    </div>
                  ...
                  {customer.otherLineBusinessUrl && (
                    <div className="flex justify-between items-center">
                      ...
                      <span 
                        className="cursor-pointer text-green-600 hover:underline"
                        onClick={() => openDocument(customer.otherLineBusinessUrl!)}
                      >
                        ✅ Uploaded
                      </span>
                    </div>
                  ...
                  {customer.shareholdersDetailsUrl && (
                    <div className="flex justify-between items-center">
                      ...
                      <span 
                        className="cursor-pointer text-green-600 hover:underline"
                        onClick={() => openDocument(customer.shareholdersDetailsUrl!)}
                      >
                        ✅ Uploaded
                      </span>
                    </div>
