...
export default function PendingCustomersPage() {
    ...
    const fetchPendingCustomers = async () => {
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(
            errorData.error || "Failed to fetch pending customers"
          );
        }
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-50 min-h-screen">
      ...
      {error && (
        <div className="text-center text-red-600 text-lg p-4 bg-red-100 rounded-lg">
          Error: {error}
        </div>
      )}
          ...
          {customers.map((customer) => (
            <Card key={customer.id} className="max-w-4xl mx-auto">
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-sm">
                ...
                {decisionData[customer.applicationReferenceNumber] && (
                ...
                <div className="space-y-4">
                  ...
                  <Separator />
                  <p>
                    <strong>TIN:</strong> {formatData(customer.tinNumber)}
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Phone:</strong> {formatData(customer.phone)}
                  </p>
                  <p>
                    <strong>Email:</strong> {formatData(customer.email)}
                  </p>
                  <p>
                    <strong>Gender:</strong> {formatData(customer.gender)}
                  </p>
                  <p>
                ...
                <div className="space-y-4">
                  ...
                  <Separator />
                  <p>
                    <strong>Region:</strong> {formatData(customer.region)}
                  </p>
                  <p>
                    <strong>Zone:</strong> {formatData(customer.zone)}
                  </p>
                  <p>
                    <strong>City:</strong> {formatData(customer.city)}
                  </p>
                  <p>
                    <strong>Subcity:</strong> {formatData(customer.subcity)}
                  </p>
                  <p>
                    <strong>Woreda:</strong> {formatData(customer.woreda)}
                  </p>
                  <p>
                ...
                <div className="space-y-4">
                  ...
                  <Separator />
                  <p>
                    <strong>Major Line of Business:</strong>{" "}
                    {formatData(customer.majorLineBusiness)}
                  </p>
                  <p>
                    <strong>Date of Establishment (MLB):</strong>{" "}
                    {formatData(
                      new Date(
                ...
                <div className="space-y-4">
                  ...
                  <Separator />
                  <p>
                    <strong>Loan Type:</strong> {formatData(customer.loanType)}
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Mode of Repayment:</strong>{" "}
                ...
                <div className="space-y-4 md:col-span-2">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <p>
                      <strong>Major Business Doc:</strong>{" "}
                    ...
                    <p>
                      <strong>Shareholders Details:</strong>{" "}
                    ...
                    <p>
                      <strong>Transaction Profile:</strong>{" "}
                      {formatData(customer.transactionProfileUrl)}
                    </p>
                    <p>
                      <strong>Collateral Profile:</strong>{" "}
                ...
                <div className="space-y-4 md:col-span-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor={`financialProfileUrl-${customer.id}`}
                        className="text-sm font-medium"
                      >
                        Financial Profile Doc
                      </label>
                      <input
                        id={`financialProfileUrl-${customer.id}`}
                        type="file"
                        onChange={(e) =>
                          handleFileUpload(
                            e,
